...
{
    public class ValidateMatchingTask : TaskActivity
    {
        #region Constants
        ...
        public override ActivityExecutionResult Execute(WorkflowExecutionContext workflowContext, ActivityContext activityContext)
        {
            ...
            var fieldsToValidate = GetFieldsToValidate();
            ...
            var matchingValue = form[fieldsToValidate[0]];

            foreach (var field in GetFieldsToValidate())
            {
                if (form[field] == matchingValue)
                {
                    continue;
                }
